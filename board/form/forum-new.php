...
<div class="form-block">
	...
	<h3 class="form-block__title"><?php mb_forum_label( 'add_new_item' ); ?></h3>

	<form id="mb-forum-form" class="mb-form mb-form-forum" method="post" action="<?php mb_board_home_url(); ?>">

		<p class="mb-form-block__title">
			<label for="mb_forum_title"><?php mb_forum_label( 'mb_form_title' ); ?></label>
			<input type="text" id="mb_forum_title" name="mb_forum_title" value="<?php echo esc_attr( mb_get_forum_title() ); ?>" placeholder="<?php echo esc_attr( mb_get_forum_label( 'mb_form_title_placeholder' ) ); ?>" required />
		...
		<p class="mb-form-content">
			...
			<textarea id="mb_forum_content" name="mb_forum_content" cols="45" rows="8" maxlength="65525"></textarea>
		</p><!-- .mb-form-content -->
